                ...
                <div class="container">
                    ...
                    <div class="n3">
                        <form action="UserReg" method="post">
                            ...
                            <input class="form" name="n2" type="Password" placeholder="Password *"><br>
                            <input class="form" name="n3" type="text" placeholder="Address *"> <br><br>
                            <input type="checkbox" >  <label class="n4">I agree the <b>Terms and Conditions</b> </lable>
